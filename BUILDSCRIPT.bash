...
SRC=("keyvalueframe/statics.cc"
     ...
     "signalbackup/dtsetlinkpreviewdata.cc"
     "signalbackup/dumpmedia.cc"
     "signalbackup/makeidsunique.cc"
     "signalbackup/decodegroupv2updatemessage.cc"
     ...
     "signalbackup/fixforeignkeyconstraintviolations.cc"
     ...
     "signalbackup/importfromadbbackup.cc"
     "signalbackup/listthreads.cc"
     "signalbackup/htmlgetemojipos.cc"
     "signalbackup/tgsetreactions.cc"
     "signalbackup/updateparttableforreplace.cc"
     ...
     "signalbackup/initemptydatabase.cc"
     ...
     "signalbackup/tgsetdeliveryreceipts.cc"
     ...
     "signalbackup/decodepollterminatemessage.cc"
     ...
     "signalbackup/specialcharssupported.cc"
     ...
     "backupv2reader/getframe.cc"
     "backupv2reader/backupv2reader.cc"
     "backupv2reader/readmain.cc"
     "backupv2reader/readpassphrase.cc"
     "backupv2reader/getkeys.cc"
     ...
     "adbbackupdatabase/decrypt.cc"
     "adbbackupattachmentreader/getattachment.cc"
...
OBJ=("keyvalueframe/o/statics.o"
     ...
     "signalbackup/o/dtsetlinkpreviewdata.o"
     "signalbackup/o/dumpmedia.o"
     "signalbackup/o/makeidsunique.o"
     "signalbackup/o/decodegroupv2updatemessage.o"
     ...
     "signalbackup/o/fixforeignkeyconstraintviolations.o"
     ...
     "signalbackup/o/importfromadbbackup.o"
     "signalbackup/o/listthreads.o"
     "signalbackup/o/htmlgetemojipos.o"
     "signalbackup/o/tgsetreactions.o"
     "signalbackup/o/updateparttableforreplace.o"
     ...
     "signalbackup/o/initemptydatabase.o"
     ...
     "signalbackup/o/tgsetdeliveryreceipts.o"
     ...
     "signalbackup/o/decodepollterminatemessage.o"
     ...
     "signalbackup/o/specialcharssupported.o"
     ...
     "backupv2reader/o/getframe.o"
     "backupv2reader/o/backupv2reader.o"
     "backupv2reader/o/readmain.o"
     "backupv2reader/o/readpassphrase.o"
     "backupv2reader/o/getkeys.o"
     ...
     "adbbackupdatabase/o/adbbackupdatabase.o"
     "adbbackupdatabase/o/decrypt.o"
     "adbbackupattachmentreader/o/getattachment.o"
