                                      ...
                                      std::vector<std::tuple<long long int, std::string, std::string>> const &chatfolders) const
{
      ...
      (chatfolder_idx >= 0 && menuitems > 0)) // we need an expandable menu
  {
    outputfile
      ...
      << "       margin-right: 5px;\n"
      << "       vertical-align: middle;\n"
      << "       background: url('data:image/svg+xml;utf-8,<svg version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 24 24\" fill=\"white\" stroke=\"none\"><path d=\"M13.5 5.5A1.5 1.5 0 1 1 12 4a1.5 1.5 0 0 1 1.5 1.5zm-1.5 5a1.5 1.5 0 1 0 1.5 1.5 1.5 1.5 0 0 0-1.5-1.5zm0 6.5a1.5 1.5 0 1 0 1.5 1.5A1.5 1.5 0 0 0 12 17z\"></path></svg>');\n"
      << "       filter: var(--icon-f);\n"
      << "       transition: background 0.25s ease-out, transform 0.25s ease-out;\n"
      << "     }\n"
      << '\n'
      << "     #menu:hover #hamburger-icon {\n"
      << "       background: url('data:image/svg+xml;utf-8,<svg version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\" width=\"30\" height=\"30\" viewBox=\"0 0 24 24\" fill=\"white\" stroke=\"white\"><g><path d=\"M21 11.25h-8.25V3h-1.5v8.25H3v1.5h8.25V21h1.5v-8.25H21v-1.5z\"></path></g></svg>');\n"
