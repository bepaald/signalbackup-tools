...
*/
std::array<std::pair<std::string, std::string>, 12> constexpr SignalBackup::s_html_random_colors{std::pair<std::string, std::string>{"A100", "E3E3FE"},
...
// list of {light, dark}
std::array<std::pair<std::string, std::string>, 36> constexpr SignalBackup::s_html_random_groupmember_colors{std::pair<std::string, std::string>{"006DA3", "00A7FA"},
