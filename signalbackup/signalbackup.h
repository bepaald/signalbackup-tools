...
class SignalBackup
{
 ...
 public:
  ...
  bool exportHtml(std::string const &directory, std::vector<long long int> const &threads,
                  ...
                  bool theme, bool themeswitching, bool addexportdetails, bool blocked, bool settings);
 ...
 private:
  ...
  void HTMLwriteIndex(std::vector<long long int> const &threads, std::string const &directory,
                      ...
                      bool searchpage, bool overwrite, bool stickerpacks, bool blocked, bool settings, bool append,
