...
Writing SqlStatementFrame(s)...
  Dealing with table 'sms'...32752 entries...
  Dealing with table 'mms'...2212 entries...
  Dealing with table 'part'...1813 entries...
  Dealing with table 'thread'...27 entries...
  Dealing with table 'identities'...19 entries...
  Dealing with table 'drafts'...0 entries...
  Dealing with table 'push'...0 entries...
  Dealing with table 'groups'...10 entries...
  Dealing with table 'recipient_preferences'...63 entries...
  Dealing with table 'group_receipts'...1195 entries...
  Dealing with table 'job_spec'...1 entries...
...
total 0
[~/programming/signalbackup-tools] $ ./signalbackup-tools --dumptodir RAWBACKUP/ ~/PHONE/signal-2019-07-14-06-59-26.backup 949543591444534240555456749437
...
[~/programming/signalbackup-tools] $ ./signalbackup-tools --readrawfromdir RAWBACKUP/ NEWBACKUPFILE 949543591444534240555368549437
Exporting backup to 'NEWBACKUPFILE'
Writing HeaderFrame...
Writing DatabaseVersionFrame...
Writing SqlStatementFrame(s)...
  Dealing with table 'sms'...34595 entries...
  Dealing with table 'mms'...2370 entries...
  Dealing with table 'part'...1934 entries...
  Dealing with table 'thread'...29 entries...
  Dealing with table 'identities'...21 entries...
  Dealing with table 'drafts'...0 entries...
  Dealing with table 'push'...0 entries...
  Dealing with table 'groups'...10 entries...
  Dealing with table 'recipient_preferences'...67 entries...
  Dealing with table 'group_receipts'...1320 entries...
  Dealing with table 'job_spec'...1 entries...
  Dealing with table 'constraint_spec'...0 entries...
  Dealing with table 'dependency_spec'...0 entries...
...
Writing EndFrame...
Done!
[~/programming/signalbackup-tools] $ md5sum ~/PHONE/signal-2019-07-14-06-59-26.backup NEWBACKUPFILE 
2f05e9f67032d094af870493d7bcc85b  ~/PHONE/signal-2019-07-14-06-59-26.backup
2f05e9f67032d094af870493d7bcc85b  NEWBACKUPFILE
[~/programming/signalbackup-tools] $
```
