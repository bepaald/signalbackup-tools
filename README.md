![Linux build test](https://github.com/bepaald/signalbackup-tools/actions/workflows/test-linux-build.yml/badge.svg?event=push)
...
- On macOS you can use [Homebrew](https://brew.sh/) to install them: `brew install openssl sqlite3`.
- On Debian-based Linux distributions such as Ubuntu: `sudo apt-get install libssl-dev libsqlite3-dev`.
...
**<span id="cmake">Compile with CMake</span>**

The easiest way to compile the project is by using [CMake](https://cmake.org):
```shell
cmake -B build
cmake --build build --parallel 16
```

The built executable can be found at `build/signalbackup-tools`.

**<span id="manually">Compile manually</span>**
...
**<span id="export">Export HTML, CSV & XML</span>**
