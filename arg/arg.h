...
class Arg
{
  std::array<std::string, 207> const d_alloptions{"--adbpassphrase", "--rawdesktopdb", "--desktopkey", "--dumpmedia", "--dumpavatars", "--importcsv", "--setselfid", "--onlyolderthan", "--onlynewerthan", "--appendbody", "--prependbody", "--exporthtml", "--exportdesktophtml", "--importadbbackup", "-p", "--passphrase", "--exportadbbackuptohtml", "--split-by", "--exporttxt", "--exportdesktoptxt", "--importtelegram", "--listjsonchats", "--jsonshowcontactmap", "-l", "--logfile", "--mapxmlcontactnamesfromfile", "--mapxmladdressesfromfile", "--setcountrycode", "--generatedummy", "--generatedummyfordesktop", "--desktopdir", "--exportxml", "--querymode", "-o", "--output", "-op", "--opassphrase", "-i", "--input", "-s", "--source", "-sp", "--sourcepassphrase", "--dumpdesktopdb", "--desktopdirs", "--setchatcolors", "--selectxmlchats", "--listxmlcontacts", "--replaceattachments", "--croptothreads", "--mapxmlcontacts", "--limittodates", "--runsqlquery", "--exportplaintextbackuphtml", "--importplaintextbackup", "--exportcsv", "--mergegroups", "--mergerecipients", "--preventjsonmapping", "--mapjsoncontacts", "--selectjsonchats", "--croptodates", "--croptothreadsbyname", "--limittothreadsbyname", "--importthreads", "--limitcontacts", "--mapcsvfields", "--htmlignoremediatypes", "--editattachmentsize", "--importthreadsbyname", "--limittothreads", "--mapxmladdresses", "--onlyinthreads", "--onlytype", "--runprettysqlquery", "--rundtsqlquery", "--rundtprettysqlquery", "--mapxmlcontactnames", "--findrecipient", "--split", "--hiperfall", "--onlylargerthan", "--desktopdbversion", "--removedoubles", "--aggressivefilenamesanitizing", "--no-aggressivefilenamesanitizing", "--importstickers", "--no-importstickers", "--append", "--no-append", "--autofixfkc", "--no-autofixfkc", "--htmlpagemenu", "--no-htmlpagemenu", "--migratedb", "--no-migratedb", "--targetisdummy", "--no-targetisdummy", "--jsonprependforward", "--no-jsonprependforward", "--jsonmarkdelivered", "--no-jsonmarkdelivered", "--jsonmarkread", "--no-jsonmarkread", "--xmlmarkdelivered", "--no-xmlmarkdelivered", "--xmlmarkread", "--no-xmlmarkread", "--fulldecode", "--no-fulldecode", "--compactfilenames", "--no-compactfilenames", "--xmlautogroupnames", "--no-xmlautogroupnames", "--custom_hugogithubs", "--no-custom_hugogithubs", "--truncate", "--no-truncate", "--skipmessagereorder", "--no-skipmessagereorder", "--migrate_to_191", "--no-migrate_to_191", "--linkify", "--no-linkify", "--reordermmssmsids", "--no-reordermmssmsids", "--autolimitdates", "--no-autolimitdates", "--importfromdesktop", "--no-importfromdesktop", "--scramble", "--no-scramble", "--showdbinfo", "--no-showdbinfo", "--scanmissingattachments", "--no-scanmissingattachments", "-h", "--help", "--no-help", "--deleteattachments", "--no-deleteattachments", "--dbusverbose", "--no-dbusverbose", "-v", "--verbose", "--no-verbose", "--stoponerror", "--no-stoponerror", "--ignorewal", "--no-ignorewal", "--showprogress", "--no-showprogress", "--listrecipients", "--no-listrecipients", "--listthreads", "--no-listthreads", "--overwrite", "--no-overwrite", "--onlydb", "--no-onlydb", "--assumebadframesizeonbadmac", "--no-assumebadframesizeonbadmac", "--devcustom", "--no-devcustom", "--excludestickers", "--no-excludestickers", "--showdesktopkey", "--no-showdesktopkey", "--searchpage", "--no-searchpage", "--importdesktopcontacts", "--no-importdesktopcontacts", "--addincompletedataforhtmlexport", "--no-addincompletedataforhtmlexport", "--htmlfocusend", "--no-htmlfocusend", "--originalfilenames", "--no-originalfilenames", "--excludeexpiring", "--no-excludeexpiring", "--chatfolders", "--no-chatfolders", "--includereceipts", "--no-includereceipts", "--stickerpacks", "--no-stickerpacks", "--light", "--no-light", "--themeswitching", "--no-themeswitching", "--includefullcontactlist", "--no-includefullcontactlist", "--includesettings", "--no-includesettings", "--includeblockedlist", "--no-includeblockedlist", "--includecalllog", "--no-includecalllog", "--addexportdetails", "--no-addexportdetails", "--interactive", "--no-interactive", "--checkdbintegrity", "--no-checkdbintegrity", "--includemms", "--no-includemms", "--allhtmlpages"};
