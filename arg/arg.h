...
class Arg
{
  ...
  std::string d_exportstickerpackshtml;
 ...
 public:
  ...
  inline std::string const &exportstickerpackshtml() const;
...
inline std::string const &Arg::exportstickerpackshtml() const
{
  return d_exportstickerpackshtml;
}
